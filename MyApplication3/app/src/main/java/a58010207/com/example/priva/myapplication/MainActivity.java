...
import static a58010207.com.example.priva.myapplication.constant.CONTENT;
import static a58010207.com.example.priva.myapplication.constant.TABLE_NAME;
import static a58010207.com.example.priva.myapplication.constant.TIME;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void showNotes(Cursor cursor) {
        ...
        while (cursor.moveToNext()) {
            ...
            String strDate = (String) DateFormat.format("yyyy-MM-dd hh:mm:ss", new
                    Date(time));
